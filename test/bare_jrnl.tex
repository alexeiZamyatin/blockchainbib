...
\title{Blockchainconcepts - Readinglist}
%
%
...
\begin{abstract}
%\boldmath
This file includes all relevant papers which can be used as references for the blockchain concepts project, as well as the MSc thesis of Alexei Zamyatin.
\end{abstract}
